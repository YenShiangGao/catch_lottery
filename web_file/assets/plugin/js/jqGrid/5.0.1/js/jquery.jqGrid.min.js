...
! function(a) {
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
                ...
                QueryObject = function(d, q) {
                    ...
                    return d.length > 0 && (_useProperties = "object" != typeof d[0] ? !1 : !0), this._hasData = function() {
                        ...
                        0 === d && (d = "text"), j = "float" === d || "number" === d || "currency" === d || "numeric" === d ? function(a) {
                            ...
                            return a = a.vSort, b = b.vSort, f.call(this, a, b, m) } : function(a, b) {
                            return a = a.vSort, b = b.vSort, self._compare(a, b, m) }), i = 0;
                        for (var
                        ...
                        return self._append(_useProperties ? self._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + '.indexOf("' + self._toStr(b) + '",0) > -1' : self._getStr("this") + '.indexOf("' + self._toStr(a) + '",0) > -1'), self._setCommand(self.contains, a), self._resetNegate(), self }, this.groupBy = function(a, b, c, d) {
        ...
        return this.each(function() {
            if (!this.grid) {
                ...
                var
                    ...
                    L = function(a, b, c, e) {
                        ...
                        if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            if (d.p.gridview === !0 && (n = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? g || (w.jqGrid("groupingRender", S, d.p.colModel.length, d.p.page, T), S = null) : d.p.treeGrid === !0 && n > 0 ? $(d.rows[n]).after(L.join("")) : (V.append(L.join("")), d.grid.cols = d.rows[0].cells)), d.p.subGrid === !0) try { w.jqGrid("addSubGrid", z + B) } catch (cb) {}
                            if (d.p.totaltime = new Date - f, x > 0 && 0 === d.p.records && (d.p.records = Q), L = null, d.p.treeGrid === !0) try { w.jqGrid("setTreeNode", n + 1, x + n + 1) } catch (db) {}
                    ...
                    M = function(a, b, c, e) {
                        ...
                        if (a) {
                            ...
                            if (d.p.gridview === !0 && (w = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? j || (A.jqGrid("groupingRender", _, d.p.colModel.length, d.p.page, V), _ = null) : d.p.treeGrid === !0 && w > 0 ? $(d.rows[w]).after(Q.join("")) : (bb.append(Q.join("")), d.grid.cols = d.rows[0].cells)), d.p.subGrid === !0) try { A.jqGrid("addSubGrid", J + M) } catch (gb) {}
                            if (d.p.totaltime = new Date - f, B > 0 && 0 === d.p.records && (d.p.records = t), Q = null, d.p.treeGrid === !0) try { A.jqGrid("setTreeNode", w + 1, B + w + 1) } catch (hb) {}
                    ...
                    N = function() {
                        ...
                        a(b) {
                            var
                                c, e, f, g, h, i, k = 0;
                            if (null != b.groups) {
                                for (e = b.groups.length && "OR" === b.groupOp.toString().toUpperCase(), e && r.orBegin(), c = 0; c < b.groups.length; c++) { k > 0 && e && r.or();
                                    try { a(b.groups[c]) } catch (l) { alert(l) }
                                    k++ }
                                e && r.orEnd() }
                            if (null != b.rules) try {
                        ...
                        if ($.isArray(d.p.data)) {
                            ...
                            if (d.p.ignoreCase && (r = r.ignoreCase()), d.p.search === !0) {
                                ...
                                if (u) "string" == typeof
                                u && (u = $.jgrid.parse(u)), a(u);
                                else
                                    try { f = j[d.p.postData.searchField], "date" === f.stype && f.srcfmt && f.newfmt && f.srcfmt !== f.newfmt && (d.p.postData.searchString = $.jgrid.parseDate.call(d, f.newfmt, d.p.postData.searchString, f.srcfmt)), r = q[d.p.postData.searchOper](r)(d.p.postData.searchField, d.p.postData.searchString, j[d.p.postData.searchField]) } catch (v) {}
                            } else
                            ...
                            d.p.multiSort ? $.each(g, function(a) { r.orderBy(this, h[a], j[this].stype, j[this].srcfmt, j[this].sfunc) }) : g && d.p.sortorder && i && ("DESC" === d.p.sortorder.toUpperCase() ? r.orderBy(d.p.sortname, "d", j[g].stype, j[g].srcfmt, j[g].sfunc) : r.orderBy(d.p.sortname, "a", j[g].stype, j[g].srcfmt, j[g].sfunc));
                            var
                                w = r.select(),
                    ...
                    P = function() { d.grid.hDiv.loading = !0, d.p.hiddengrid || $(d).jqGrid("progressBar", { method: "show", loadtype: d.p.loadui, htmlcontent: $.jgrid.getRegional(d, "defaults.loadtext", d.p.loadtext) }) },
                    Q = function() { d.grid.hDiv.loading = !1, $(d).jqGrid("progressBar", { method: "hide", loadtype: d.p.loadui }) },
                    R = function(a) {
                    ...
                    T = function(a, b) {
                        ...
                        "ltr" === h && (s += t), s += "</tr></tbody></table>", d.p.viewrecords === !0 && $("td#" + a + "_" + d.p.recordpos, "#" + c).append("<div dir='" + h + "' style='text-align:" + d.p.recordpos + "' class='ui-paging-info'></div>"), $("td#" + a + "_" + d.p.pagerpos, "#" + c).append(s), j = $("#gbox_" + $.jgrid.jqID(d.p.id)).css("font-size") || "11px", $("#gbox_" + $.jgrid.jqID(d.p.id)).append("<div id='testpg' " + k(l, "entrieBox", !1, "ui-jqgrid") + " style='font-size:" + j + ";visibility:hidden;' ></div>"), i = $(s).clone().appendTo("#testpg").width(), $("#testpg").remove(), i > 0 && ("" !== r && (i += 50), $("td#" + a + "_" + d.p.pagerpos, "#" + c).width(i)), d.p._nvtd = [], d.p._nvtd[0] = Math.floor(i ? (d.p.width - i) / 2 : d.p.width / 3), d.p._nvtd[1] = 0, s = null, $(".ui-pg-selbox", "#" + c).bind("change", function() {
                            return u("records", this) ? (d.p.page = Math.round(d.p.rowNum * (d.p.page - 1) / this.value - .5) + 1, d.p.rowNum = this.value, d.p.pager && $(".ui-pg-selbox", d.p.pager).val(this.value), d.p.toppager && $(".ui-pg-selbox", d.p.toppager).val(this.value), R(), !1) : !1 }), d.p.pgbuttons === !0 && ($(".ui-pg-button", "#" + c).hover(function() { $(this).hasClass(m) ? this.style.cursor = "default" : ($(this).addClass(o), this.style.cursor = "pointer") }, function() { $(this).hasClass(m) || ($(this).removeClass(o), this.style.cursor = "default") }), $("#first" + $.jgrid.jqID(b) + ", #prev" + $.jgrid.jqID(b) + ", #next" + $.jgrid.jqID(b) + ", #last" + $.jgrid.jqID(b)).click(function() {
                ...
                if (d.p.sortorder = d.p.sortorder.toLowerCase(), $.jgrid.cell_width = $.jgrid.cellWidth(), d.p.grouping === !0 && (d.p.scroll = !1, d.p.rownumbers = !1, d.p.treeGrid = !1, d.p.gridview = !0), this.p.treeGrid === !0) {
                    try { $(this).jqGrid("setTreeGrid") } catch (_) {} "local" !== d.p.datatype && (d.p.localReader = { id: "_id_" }) }
                if (this.p.subGrid) try { $(d).jqGrid("setSubGrid") } catch (ab) {}
                ...
                if (d.p.disableClick = !1, $("th", sb).each(function(a) {
                        ...
                        var
                            b = "";
                        d.p.colModel[a].hidden && ($(this).css("display", "none"), b = "display:none;"), tb += "<td role='gridcell' style='height:0px;width:" + db + "px;" + b + "'></td>", e.headers[a] = { width: db, el: this }, kb = d.p.colModel[a].sortable, "boolean" != typeof
                    ...
                    }), d.p.sortable && $.fn.sortable) try { $(d).jqGrid("sortableColumns", sb) } catch (ub) {}
                ...
                $(d).before(e.hDiv).click(function(a) {
                    ...
                    if ("A" !== fb.tagName && ("INPUT" !== fb.tagName && "TEXTAREA" !== fb.tagName && "OPTION" !== fb.tagName && "SELECT" !== fb.tagName || b)) {
                        ...
                        if (fb.length > 0) { yb = gb[0].rowIndex;
                            try { $(d).jqGrid("editCell", yb, zb, !0) } catch (f) {} }
                        if (c)
                    ...
                    return !1 }) : $(e.bDiv).bind("mousedown", function() {
                    return !1 })), wb && $(e.bDiv).hide();
                var
                    Bb = q + " " + k(l, "icon_caption_open", !0),
                    Cb = q + " " + k(l, "icon_caption_close", !0);
                e.cDiv = document.createElement("div");
                var
                    Db = d.p.hidegrid === !0 ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + p + "' title='" + ($.jgrid.getRegional(d, "defaults.showhide", d.p.showhide) || "") + "' />").hover(function() { Db.addClass(o) }, function() { Db.removeClass(o) }).append("<span class='ui-jqgrid-headlink " + Bb + "'></span>").css("rtl" === h ? "left" : "right", "0px") : "";
                ...
                if ($(e.hDiv).after(e.bDiv).mousemove(function(a) {
                        ...
                        return !1 }), $(document).bind("mouseup.jqGrid" + d.p.id, function() {
                        return e.resizing ? (e.dragEnd(!0), !1) : !0 }), d.formatCol = z, d.sortData = V, d.updatepager = O, d.refreshIndex = J, d.setHeadCheckBox = S, d.constructTr = K, d.formatter = function(a, b, c, d, e) {
                        return B(a, b, c, d, e) }, $.extend(e, { populate: R, emptyRows: H, beginReq: P, endReq: Q }), this.grid = e, d.addXmlData = function(a) { L(a) }, d.addJSONData = function(a) { M(a) }, this.grid.cols = this.rows[0].cells, $(d).triggerHandler("jqGridInitGrid"), $.isFunction(d.p.onInitGrid) && d.p.onInitGrid.call(d), R(), d.p.hiddengrid = !1, d.p.responsive) {
                    var
                        ...
                        if (a = parseInt(a, 10), g.grid.width = g.p.width = a, $("#gbox_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"), $("#gview_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"), $(g.grid.bDiv).css("width", a + "px"), $(g.grid.hDiv).css("width", a + "px"), g.p.pager && $(g.p.pager).css("width", a + "px"), g.p.toppager && $(g.p.toppager).css("width", a + "px"), g.p.toolbar[0] === !0 && ($(g.grid.uDiv).css("width", a + "px"), "both" === g.p.toolbar[1] && $(g.grid.ubDiv).css("width", a + "px")), g.p.footerrow && $(g.grid.sDiv).css("width", a + "px"), b === !1 && g.p.forceFit === !0 && (g.p.forceFit = !1), b === !0) {
                            ...
                            if ($.each(g.p.colModel, function(a) {
                                    if (this.hidden === !1 && !this.fixed) {
                                        ...
                                        this.width = c, h += c, g.grid.headers[a].width = c, g.grid.headers[a].el.style.width = c + "px", g.p.footerrow && (g.grid.footers[a].style.width = c + "px"), n && (g.grid.cols[a].style.width = c + "px"), d = a } }), !d) return;
        ...
        getCell: function(a, b) {
            ...
            return this.each(function() {
                ...
                if (d.grid && (isNaN(b) ? $(d.p.colModel).each(function(a) {
                    ...
                    if (f) try { c = $.unformat.call(d, $("td:eq(" + e + ")", f), { rowId: f.id, colModel: d.p.colModel[e] }, e) } catch (g) { c = $.jgrid.htmlDecode($("td:eq(" + e + ")", f).html()) }
                }
            }), c
        },
        ...
        unbindKeys: function() {
            return this.each(function() { $(this).unbind("keydown") }) },
...
! function(a) {
    ...
    a.extend(a.jgrid, {
        ...
        viewModal: function(b, c) {
            if (c = a.extend({ toTop: !0, overlay: 10, modal: !1, overlayClass: "ui-widget-overlay", onShow: a.jgrid.showModal, onHide: a.jgrid.closeModal, gbox: "", jqm: !0, jqM: !0 }, c || {}), void 0 === c.focusField && (c.focusField = 0), c.focusField = "number" == typeof c.focusField && c.focusField >= 0 ? parseInt(c.focusField, 10) : "boolean" != typeof c.focusField || c.focusField ? 0 : !1, a.fn.jqm && c.jqm === !0) c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow();
            else
        ...
        info_dialog: function(b, c, d, e) {
            ...
            a.jgrid.createModal({ themodal: "info_dialog", modalhead: "info_head", modalcontent: "info_content", scrollelm: "infocnt" }, o, f, "", "", !0), l && a.each(f.buttons, function(b) { a("#" + a.jgrid.jqID(this.id), "#info_id").bind("click", function() {
                    return f.buttons[b].onClick.call(a("#info_dialog")), !1 }) }), a("#closedialog", "#info_id").click(function() {
                        ...
                        i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
                            ...
                            success: function(b) {
                                ...
                                m && (m = a(a.trim(m)).html()), m && (a(e).append(m), g(e, h, o ? ["postData"] : void 0), void 0 === h.size && (h.size = j ? 3 : 1), j ? (d = f.split(","), d = a.map(d, function(b) {
                                    return a.trim(b) })) : d[0] = a.trim(f), setTimeout(function() {
                                    if (a("option", e).each(function(b) { c = a(this).text(), f = a(this).val() || c, k && (l += (0 !== b ? ";" : "") + f + ":" + c), 0 === b && e.multiple && (this.selected = !1), a(this).attr("role", "option"), (a.inArray(a.trim(c), d) > -1 || a.inArray(a.trim(f), d) > -1) && (this.selected = "selected") }), k)
    ...
    a.jgrid.extend({
        editGridRow: function(c, d) {
            ...
            return d = a.extend(!0, { top: 0, left: 0, width: "500", datawidth: "auto", height: "auto", dataheight: "auto", modal: !1, overlay: 30, drag: !0, resize: !0, url: null, mtype: "POST", clearAfterAdd: !0, closeAfterEdit: !1, reloadAfterSubmit: !0, onInitializeForm: null, beforeInitData: null, beforeShowForm: null, afterShowForm: null, beforeSubmit: null, afterSubmit: null, onclickSubmit: null, afterComplete: null, onclickPgButtons: null, afterclickPgButtons: null, editData: {}, recreateForm: !1, jqModal: !0, closeOnEscape: !1, addedrow: "first", topinfo: "", bottominfo: "", saveicon: [], closeicon: [], savekey: [!1, 13], navkeys: [!1, 38, 40], checkOnSubmit: !1, checkOnUpdate: !1, _savedData: {}, processing: !1, onClose: null, ajaxEditOptions: {}, serializeEditData: null, viewPagerButtons: !0, overlayClass: h.overlay, removemodal: !0, form: "edit", template: null, focusField: !0 }, e, d || {}), b[a(this)[0].p.id] = d, this.each(function() {
                        ...
                        if (c.length) {
                            ...
                            a.each(r.p.colModel, function() {
                                if (this.name === e && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                                    ...
                                    } catch (c) { "e1" === c ? a.jgrid.info_dialog(F.errcap, "function 'custom_value' " + b[a(this)[0]].p.msg.novalue, b[a(this)[0]].p.bClose, { styleUI: b[a(this)[0]].p.styleUI }) : a.jgrid.info_dialog(F.errcap, c.message, b[a(this)[0]].p.bClose, { styleUI: b[a(this)[0]].p.styleUI }) }
                                    return !0
                                }
                            })
                        } else {
                            switch (a(this).get(0).type) {
                                ...
                                case "select-multiple":
                                    ...
                                    var
                                        g = [];
                                    a("option:selected", this).each(function(b, c) { g[b] = a(c).text() });
                                    break;
                                case "password":
                                case "text":
                                case "textarea":
                    ...
                    if ("_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function(n) {
                            if (h = this.name, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && this.editable === !0 && "rn" !== h) {
                                ...
                                if (h === d.p.ExpandColumn && d.p.treeGrid === !0) k = a("td[role='gridcell']:eq(" + n + ")", d.rows[q]).text();
                                    ...
                                    try { k = a.unformat.call(d, a("td[role='gridcell']:eq(" + n + ")", d.rows[q]), { rowId: c, colModel: this }, n) } catch (s) { k = this.edittype && "textarea" === this.edittype ? a("td[role='gridcell']:eq(" + n + ")", d.rows[q]).text() : a("td[role='gridcell']:eq(" + n + ")", d.rows[q]).html() }(!k || "&nbsp;" === k || "&#160;" === k || 1 === k.length && 160 === k.charCodeAt(0)) && (k = "") }
                                var
                                    u = a.extend({}, this.editoptions || {}, { id: h, name: h, rowId: c, oper: "edit" }),
                            ...
                            switch (r.p.autoencode && (g = a.jgrid.htmlDecode(g)), (b[r.p.id].checkOnSubmit === !0 || b[r.p.id].checkOnUpdate) && (b[r.p.id]._savedData[f] = g), f = a.jgrid.jqID(f), m[h].edittype) {
                                ...
                                case "custom":
                                    try {
                                        ...
                                        m[h].editoptions.custom_value.call(r, a("#" + f, e), "set", g) } catch (n) { "e1" === n ? a.jgrid.info_dialog(F.errcap, "function 'custom_value' " + b[a(this)[0]].p.msg.nodefined, a.rp_ge[a(this)[0]].p.bClose, { styleUI: b[a(this)[0]].p.styleUI }) : a.jgrid.info_dialog(F.errcap, n.message, a.rp_ge[a(this)[0]].p.bClose, { styleUI: b[a(this)[0]].p.styleUI }) }
                            }
                            l++
                        }
                    }), l > 0 && a("#id_g", z).val(c))
                ...
                function
                j() { a.each(r.p.colModel, function(a, b) { b.editoptions && b.editoptions.NullIfEmpty === !0 && t.hasOwnProperty(b.name) && "" === t[b.name] && (t[b.name] = "null") }) }
                ...
                k() {
                    ...
                    if (j(), n[0] && (o = a(r).triggerHandler("jqGridAddEditClickSubmit", [b[r.p.id], t, v]), void 0 === o && a.isFunction(b[r.p.id].onclickSubmit) && (o = b[r.p.id].onclickSubmit.call(r, b[r.p.id], t, v) || {}), n = a(r).triggerHandler("jqGridAddEditBeforeSubmit", [t, a(x), v]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[r.p.id].beforeSubmit) && (n = b[r.p.id].beforeSubmit.call(r, t, a(x), v))), n[0] && !b[r.p.id].processing) {
                        ...
                        if (y.url || b[r.p.id].useDataProxy || (a.isFunction(r.p.dataProxy) ? b[r.p.id].useDataProxy = !0 : (n[0] = !1, n[1] += " " + F.nourl)), n[0])
                            ...
                            } else "clientArray" === y.url ? (b[r.p.id].reloadAfterSubmit = !1, t = y.data, y.complete({ status: 200, statusText: "" }, "")) : a.ajax(y)
                    }
                ...
                l(a, b) {
                    ...
                    for (c in
                        a)
                        if (a.hasOwnProperty(c) && a[c] != b[c]) { d = !0;
                            break }
                    return d
                }
                ...
                n() {
                    ...
                    if ("_empty" !== c && void 0 !== r.p.savedRow && r.p.savedRow.length > 0 && a.isFunction(a.fn.jqGrid.restoreRow))
                        for (b = 0; b < r.p.savedRow.length; b++)
                            if (r.p.savedRow[b].id === c) { a(r).jqGrid("restoreRow", c);
                                break }
                }
                ...
                if (r.grid && c) {
                    var
                        ...
                        y = "TblGrid_" + w,
                        z = "#" + a.jgrid.jqID(y),
                        A = { themodal: "editmod" + w, modalhead: "edithd" + w, modalcontent: "editcnt" + w, scrollelm: x },
                        B = !0,
                        C = 1,
                        D = 0,
                        E = "string" == typeof
                    ...
                    if (E ? (H = q(b[a(this)[0].p.id].template), s = z) : (H = a("<table id='" + y + "' class='EditTable ui-common-table'><tbody></tbody></table>"), s = z + "_2"), x = "#" + a.jgrid.jqID(x), a(K).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(K).append("<div class='tinfo topinfo'>" + b[r.p.id].topinfo + "</div>"), a(r.p.colModel).each(function() {
                        ...
                        if (S += "</tbody></table>", D > 0) {
                            var
                                T = [];
                            a.each(a(H)[0].rows, function(a, b) { T[a] = b }), T.sort(function(a, b) {
                                return a.rp > b.rp ? 1 : a.rp < b.rp ? -1 : 0 }), a.each(T, function(b, c) { a("tbody", H).append(c) })
                        }
                        ...
                        if (E ? (a(K).find("#pData").replaceWith(O), a(K).find("#nData").replaceWith(P), a(K).find("#sData").replaceWith(Q), a(K).find("#cData").replaceWith(R), V = a("<div id=" + y + "></div>").append(K)) : V = a("<div></div>").append(K).append(S), a(K).append("<div class='binfo topinfo bottominfo'>" + b[r.p.id].bottominfo + "</div>"), a.jgrid.createModal(A, V, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(r.p.id), a("#gbox_" + a.jgrid.jqID(r.p.id))[0]), L && (a("#pData, #nData", z + "_2").css("float", "right"), a(".EditButton", z + "_2").css("text-align", "left")), b[r.p.id].topinfo && a(".tinfo", x).show(), b[r.p.id].bottominfo && a(".binfo", x).show(), V = null, S = null, a("#" + a.jgrid.jqID(A.themodal)).keydown(function(c) {
                                ...
                                if (27 === c.which) return m() ? (U && a.jgrid.hideModal("#" + a.jgrid.jqID(A.themodal), { gb: d.gbox, jqm: d.jqModal, onClose: b[r.p.id].onClose, removemodal: b[r.p.id].removemodal, formprop: !b[r.p.id].recreateForm, form: b[r.p.id].form }), !1) : !1;
                            ...
                            W++, a("<div class='" + d.overlayClass + " jqgrid-overlay confirm' style='z-index:" + W + ";display:none;'>&#160;</div><div class='confirm ui-jqconfirm " + h.content + "' style='z-index:" + (W + 1) + "'>" + d.saveData + "<br/><br/>" + Q + P + R + "</div>").insertAfter(x), a("#sNew", "#" + a.jgrid.jqID(A.themodal)).click(function() {
                                return k(), a(x).data("disabled", !1), a(".confirm", "#" + a.jgrid.jqID(A.themodal)).hide(), !1 }), a("#nNew", "#" + a.jgrid.jqID(A.themodal)).click(function() {
                                return a(".confirm", "#" + a.jgrid.jqID(A.themodal)).hide(), a(x).data("disabled", !1), setTimeout(function() { a(":input:visible", x)[0].focus() }, 0), !1 }), a("#cNew", "#" + a.jgrid.jqID(A.themodal)).click(function() {
                                return a(".confirm", "#" + a.jgrid.jqID(A.themodal)).hide(), a(x).data("disabled", !1), a.jgrid.hideModal("#" + a.jgrid.jqID(A.themodal), { gb: "#gbox_" + a.jgrid.jqID(w), jqm: d.jqModal, onClose: b[r.p.id].onClose, removemodal: b[r.p.id].removemodal, formprop: !b[r.p.id].recreateForm, form: b[r.p.id].form }), !1 })
                        }
                        a(r).triggerHandler("jqGridAddEditInitializeForm", [a(x), v]), a.isFunction(b[r.p.id].onInitializeForm) && b[r.p.id].onInitializeForm.call(r, a(x), v), "_empty" !== c && b[r.p.id].viewPagerButtons ? a("#pData,#nData", s).show() : a("#pData,#nData", s).hide(), a(r).triggerHandler("jqGridAddEditBeforeShowForm", [a(x), v]), a.isFunction(b[r.p.id].beforeShowForm) && b[r.p.id].beforeShowForm.call(r, a(x), v), a("#" + a.jgrid.jqID(A.themodal)).data("onClose", b[r.p.id].onClose), a.jgrid.viewModal("#" + a.jgrid.jqID(A.themodal), {
                            ...
                            onHide: function(b) {
                                ...
                                c.indexOf("px") > -1 && (c = parseFloat(c)), d.indexOf("px") > -1 && (d = parseFloat(d)), a(r).data("formProp", { top: parseFloat(a(b.w).css("top")), left: parseFloat(a(b.w).css("left")), width: d, height: c, dataheight: a(x).height(), datawidth: a(x).width() }), b.w.remove(), b.o && b.o.remove()
                            }
                            ...
                            return t = {}, a(".FormError", x).hide(), e(), "_empty" === t[r.p.id + "_id"] ? k() : d.checkOnSubmit === !0 ? (u = l(t, b[r.p.id]._savedData), u ? (a(x).data("disabled", !0), a(".confirm", "#" + a.jgrid.jqID(A.themodal)).show()) : k()) : k(), !1 }), a("#cData", s).click(function() {
                            return m() ? (a.jgrid.hideModal("#" + a.jgrid.jqID(A.themodal), { gb: "#gbox_" + a.jgrid.jqID(w), jqm: d.jqModal, onClose: b[r.p.id].onClose, removemodal: b[r.p.id].removemodal, formprop: !b[r.p.id].recreateForm, form: b[r.p.id].form }), !1) : !1 }), a("#nData", s).click(function() {
                            if (!m()) return !1;
                            a(".FormError", x).hide();
                            var
                                b = p();
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    ...
                    this.onchange = function() {
                        ...
                        if (k.append(l), this.p.ruleButtons === !0) {
                            ...
                            m.append(o).bind("change", function() { b.groupOp = a(m).val(), f.onchange() })
                        }
                        var
                            p = "<span></span>";
                        ...
                        r.append(t), t.bind("change", function() {
                            ...
                            if (l) {
                                ...
                                var
                                    e = "",
                                    g = 0;
                                for (u = [], a.each(n.p.ops, function() { u.push(this.oper) }), d = 0; d < h.length; d++) s = a.inArray(h[d], u), -1 !== s && (0 === g && (b.op = n.p.ops[s].oper), e += "<option value='" + n.p.ops[s].oper + "'>" + n.p.ops[s].text + "</option>", g++);
                                ...
                                }), setTimeout(function() { b.data = a(c).val(), n.onchange() }, 0)
                            }
                        });
                        var
                            v = 0;
                        ...
                        p.append(C), C.append(A), a.jgrid.bindEv.call(o, A, l.searchoptions), a(A).addClass("input-elm " + i.srInput).bind("change", function() { b.data = "custom" === l.inputtype ? l.searchoptions.custom_value.call(o, a(this).children(".customelement:first"), "get") : a(this).val(), n.onchange() });
                        var
                            D = a("<td></td>");
            ...
            return b = a.extend({ autosearch: !0, autosearchDelay: 500, searchOnEnter: !0, beforeSearch: null, afterSearch: null, beforeClear: null, afterClear: null, searchurl: "", stringResult: !1, groupOp: "AND", defaultSearch: "bw", searchOperators: !1, resetIcon: "x", operands: { eq: "==", ne: "!", lt: "<", le: "<=", gt: ">", ge: ">=", bw: "^", bn: "!^", "in": "=", ni: "!=", ew: "|", en: "!@", cn: "~", nc: "!~", nu: "#", nn: "!#" } }, c, b || {}), this.each(function() {
                ...
                if (!d.p.filterToolbar) {
                        ...
                        k = function() {
                            ...
                            if (b.stringResult === !0 || "local" === d.p.datatype || b.searchOperators === !0) {
                                var
                                    ...
                                    l = 0;
                                a.each(g, function(a, b) { l > 0 && (k += ","), k += '{"field":"' + a + '",', k += '"op":"' + i[a] + '",', b += "", k += '"data":"' + b.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', l++ }), k += "]}", a.extend(d.p.postData, { filters: k }), a.each(["searchField", "searchString", "searchOper"], function(a, b) {
                    ...
                    b.restoreFromFilters && (g = d.p.postData.filters, g && ("string" == typeof g && (g = a.jgrid.parse(g)), f = g.rules.length ? g.rules : !1)), a.each(d.p.colModel, function(c) {
                        ...
                        if (this.hidden === !0 && a(v).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), g = a.extend({}, this.searchoptions || {}, { name: s.index || s.name, id: "gs_" + d.p.idPrefix + s.name, oper: "search" }), this.search) {
                    ...
                    }), a("body").on("click", function(b) { "soptclass" !== b.target.className && a("#sopt_menu").hide() })), a(".clearsearchclass", o).click(function() {
                        var
...
! function(a) {
    ...
    a.jgrid.inlineEdit = a.jgrid.inlineEdit || {}, a.jgrid.extend({
                ...
                if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
                    ...
                    if (a('td[role="gridcell"]', p).each(function(b) {
                                    ...
                                    case "select":
                                        if (z.editoptions.multiple) {
                                            var
                                                d = a("select", this),
                                                e = [];
                                            r[l] = a(d).val(), r[l] = r[l] ? r[l].join(",") : "", a("select option:selected", this).each(function(b, c) { e[b] = a(c).text() }), s[l] = e.join(",")
                                        } else
                        ...
                        try {
                            var
                                ...
                                B = a.jgrid.findPos(A);
                            a.jgrid.info_dialog(w.errcap, o[1], x.bClose, { left: B[0], top: B[1] + a(A).outerHeight(), styleUI: k.p.styleUI })
                        } catch (C) { alert(o[1]) }
                        return q
                    }
                    var
                    ...
                    if ("clientArray" === j.url) {
                        ...
                        for (a(p).attr("editable", "0"), J = 0; J < k.p.savedRow.length; J++)
                            if (String(k.p.savedRow[J].id) === String(F)) { n = J;
                                break }
                        ...
                        a(k).jqGrid("progressBar", { method: "show", loadtype: j.saveui, htmlcontent: j.savetext }), t = a.extend({}, r, t), t[D] = a.jgrid.stripPref(k.p.idPrefix, t[D]), a.ajax(a.extend({
                            url: j.url,
                                    ...
                                    if (e = a(k).triggerHandler("jqGridInlineSuccessSaveRow", [c, b, j]), a.isArray(e) || (e = [!0, t]), e[0] && a.isFunction(j.successfunc) && (e = j.successfunc.call(k, c)), a.isArray(e) ? (g = e[0], r = e[1] || r) : g = e, g === !0) {
                                        for (k.p.autoencode && a.each(r, function(b, c) { r[b] = a.jgrid.htmlDecode(c) }), u && a.each(r, function(a) { "null" === r[a] && (r[a] = "") }), r = a.extend({}, r, s), a(k).jqGrid("setRowData", b, r), a(p).attr("editable", "0"), f = 0; f < k.p.savedRow.length; f++)
                                            if (String(k.p.savedRow[f].id) === String(b)) { n = f;
                                                break }
                                        n >= 0 && k.p.savedRow.splice(n, 1), a(k).triggerHandler("jqGridInlineAfterSaveRow", [b, c, r, j]), a.isFunction(j.aftersavefunc) && j.aftersavefunc.call(k, b, c, r, j), q = !0, a(p).removeClass("jqgrid-new-row").unbind("keydown") } else
                ...
                if (f.grid && (c = a(f).jqGrid("getInd", b, !0), c !== !1)) {
                    ...
                    if (void 0 === i && (i = !0), i) {
                        ...
                        if (g >= 0) {
                            ...
                            a.each(f.p.colModel, function() { this.editable === !0 && f.p.savedRow[g].hasOwnProperty(this.name) && (h[this.name] = f.p.savedRow[g][this.name]) }), a(f).jqGrid("setRowData", b, h), a(c).attr("editable", "0").unbind("keydown"), f.p.savedRow.splice(g, 1), a("#" + a.jgrid.jqID(b), "#" + a.jgrid.jqID(f.p.id)).hasClass("jqgrid-new-row") && setTimeout(function() { a(f).jqGrid("delRowData", b), a(f).jqGrid("showAddEditButtons") }, 0) }
        ...
        inlineNav: function(b, c) {
            ...
            return c = a.extend(!0, { edit: !0, editicon: f.icon_edit_nav, add: !0, addicon: f.icon_add_nav, save: !0, saveicon: f.icon_save_nav, cancel: !0, cancelicon: f.icon_cancel_nav, addParams: { addRowParams: { extraparam: {} } }, editParams: {}, restoreAfterSelect: !0 }, e, c || {}), this.each(function() {
                if (this.grid && !this.p.inlineNav) {
                    ...
                    c.add && a(d).jqGrid("navButtonAdd", b, { caption: c.addtext, title: c.addtitle, buttonicon: c.addicon, id: d.p.id + "_iladd", internal: !0, onClickButton: function() { a(d).jqGrid("addRow", c.addParams), c.addParams.useFormatter || (a("#" + f + "_ilsave").removeClass(g), a("#" + f + "_ilcancel").removeClass(g), a("#" + f + "_iladd").addClass(g), a("#" + f + "_iledit").addClass(g)) } }), c.edit && a(d).jqGrid("navButtonAdd", b, {
                        caption: c.edittext,
                        title: c.edittitle,
                        ...
                        onClickButton: function() {
                            ...
                            b ? (a(d).jqGrid("editRow", b, c.editParams), a("#" + f + "_ilsave").removeClass(g), a("#" + f + "_ilcancel").removeClass(g), a("#" + f + "_iladd").addClass(g), a("#" + f + "_iledit").addClass(g)) : (a.jgrid.viewModal("#alertmod_" + f, { gbox: "#gbox_" + f, jqm: !0 }), a("#jqg_alrt").focus())
                        }
                    ...
                    }), a("#" + f + "_ilcancel").addClass(g)), c.restoreAfterSelect === !0 && a(d).bind("jqGridBeforeSelectRow.inlineNav", function(b, e) { d.p.savedRow.length > 0 && d.p.inlineNav === !0 && e !== d.p.selrow && null !== d.p.selrow && (d.p.selrow === c.addParams.rowID ? a(d).jqGrid("delRowData", d.p.selrow) : a(d).jqGrid("restoreRow", d.p.selrow, c.editParams), a(d).jqGrid("showAddEditButtons")) })
                }
            })
        },
                ...
                if (i.grid && i.p.cellEdit === !0) {
                    ...
                    if (h = i.p.colModel[c], e = h.name, "subgrid" !== e && "cb" !== e && "rn" !== e) {
                        if (g = a("td:eq(" + c + ")", i.rows[b]), h.editable !== !0 || d !== !0 || g.hasClass("not-editable-cell") || a.isFunction(i.p.isCellEditable) && !i.p.isCellEditable.call(i, e, b, c)) parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0 && a(i.rows[i.p.iRow]).removeClass("selected-row " + k).find("td:eq(" + i.p.iCol + ")").removeClass("edit-cell " + j), g.addClass("edit-cell " + j), a(i.rows[b]).addClass("selected-row " + k), f = g.html().replace(/\&#160\;/gi, ""), a(i).triggerHandler("jqGridSelectCell", [i.rows[b].id, e, f, b, c]), a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c);
                            ...
                            try { f = a.unformat.call(i, g, { rowId: i.rows[b].id, colModel: h }, c) } catch (m) { f = h.edittype && "textarea" === h.edittype ? a(g).text() : a(g).html() }
                            ...
                            a.inArray(h.edittype, ["text", "textarea", "password", "select"]) > -1 && a(p).addClass(l), a(g).html("").append(p).attr("tabindex", "0"), a.jgrid.bindEv.call(i, p, o), window.setTimeout(function() { a(p).focus() }, 1), a("input, select, textarea", g).bind("keydown", function(d) {
                    ...
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        ...
                        if (i !== e.p.savedRow[d].v) {
                            ...
                            if (u[0] === !0) {
                                ...
                                if (a.isFunction(e.p.beforeSubmitCell) && (v = e.p.beforeSubmitCell.call(e, e.rows[b].id, l, h, b, c), v || (v = {})), a("input.hasDatepicker", j).length > 0 && a("input.hasDatepicker", j).datepicker("hide"), "remote" === e.p.cellsubmit)
                                    if (e.p.cellurl) {
                                        var
                                            w = {};
                                        ...
                                        var
                                            x, y, z;
                                        z = e.p.prmNames, x = z.id, y = z.oper, w[x] = a.jgrid.stripPref(e.p.idPrefix, e.rows[b].id), w[y] = z.editoper, w = a.extend(v, w), a(e).jqGrid("progressBar", { method: "show", loadtype: e.p.loadui, htmlcontent: a.jgrid.getRegional(e, "defaults.savetext") }), e.grid.hDiv.loading = !0, a.ajax(a.extend({
                                            url: e.p.cellurl,
                                            ...
                                            complete: function(d, k) {
                                                if (a(e).jqGrid("progressBar", { method: "hide", loadtype: e.p.loadui }), e.grid.hDiv.loading = !1, "success" === k) {
                                                    var
                                                        m = a(e).triggerHandler("jqGridAfterSubmitCell", [e, d, w.id, l, h, b, c]) || [!0, ""];
                                ...
                                try { window.setTimeout(function() { a.jgrid.info_dialog(f.errcap, h + " " + u[1], g.bClose, { styleUI: e.p.styleUI, top: n.top + 40, left: n.left }) }, 100), a(e).jqGrid("restoreCell", b, c) } catch (r) {}
                        } else
...
! function(a) {
    ...
    a.fn.jqDrag = function(a) {
        ...
        return g(this, a, "r", b) }, a.jqDnR = { dnr: {}, e: 0, drag: function(a) {
            return "d" == e.k ? f.css({ left: e.X + a.pageX - e.pX, top: e.Y + a.pageY - e.pY }) : (f.css({ width: Math.max(a.pageX - e.pX + e.W, 0), height: Math.max(a.pageY - e.pY + e.H, 0) }), c && b.css({ width: Math.max(a.pageX - c.pX + c.W, 0), height: Math.max(a.pageY - c.pY + c.H, 0) })), !1 }, stop: function() { a(document).unbind("mousemove", d.drag).unbind("mouseup", d.stop) } };
    var
        b, c, d = a.jqDnR,
        e = d.dnr,
        f = d.e,
    ...
    a.fn.tinyDraggable = function(b) {
        ...
        return this.each(function() {
            ...
            f.on({
                ...
                mouseup: function() { a(document).off("mousemove.drag") }
            })
        })
    }
});
    ...
    a.jgrid.extend({
            ...
            return this.each(function() {
                ...
                if (g.plusicon || (g.plusicon = h.icon_plus), g.minusicon || (g.minusicon = h.icon_minus), g.groupField.length) {
                    ...
                    for (g.summary = [], g.hideFirstGroupCol && (g.formatDisplayField[0] = function(a) {
                        ...
                        return "" })), f[c].summaryType && g.summary.push(f[c].summaryDivider ? { nm: f[c].name, st: f[c].summaryType, v: "", sd: f[c].summaryDivider, vd: "", sr: f[c].summaryRound, srt: f[c].summaryRoundType || "round" } : { nm: f[c].name, st: f[c].summaryType, v: "", sr: f[c].summaryRound, srt: f[c].summaryRoundType || "round" })
                } else
                    e.p.grouping = !1
            })
        },
        ...
        groupingRender: function(b, c, d, e) {
            return this.each(function() {
                ...
                u.reverse(), s = k.p.multiselect ? ' colspan="2"' : "", a.each(l.groups, function(f, v) {
                    ...
                    try { a.isArray(l.formatDisplayField) && a.isFunction(l.formatDisplayField[v.idx]) ? (v.displayValue = l.formatDisplayField[v.idx].call(k, v.displayValue, v.value, k.p.colModel[p[v.idx]], v.idx, l), j = v.displayValue) : j = k.formatter(h, v.displayValue, p[v.idx], v.value) } catch (w) { j = v.displayValue }
                    var
                        x = "";
        ...
        setGroupHeaders: function(b) {
            return b = a.extend({ useColSpanStyle: !1, groupHeaders: [] }, b || {}), this.each(function() {
                ...
                })), A = p.find("tr.jqg-first-row-header"), a(q).bind("jqGridResizeStop.setGroupHeaders", function(a, b, c) { A.find("th").eq(c).width(b) })
            })
        },
        destroyGroupHeader: function(b) {
            ...
            0 === b && (b = !0), this.each(function() {
                var
                    ...
                    m = j.p.colModel;
                if (k) {
                    for (a(this).unbind(".setGroupHeaders"), c = a("<tr>", { role: "row" }).addClass("ui-jqgrid-labels"), f = k.headers, d = 0, e = f.length; e > d; d++) { i = m[d].hidden ? "none" : "", g = a(f[d].el).width(f[d].width).css("display", i);
        ...
        getRootNodes: function(b) {
            ...
            return this.each(function() {
                ...
                if (g.grid && g.p.treeGrid) switch ("boolean" != typeof b && (b = !1), f = b ? a(g).jqGrid("getRowData", null, !0) : g.p.data, g.p.treeGridModel) {
                    case "nested":
                        d = g.p.treeReader.level_field, a(f).each(function() { parseInt(this[d], 10) === parseInt(g.p.tree_root_level, 10) && c.push(b ? g.p.data[g.p._index[this[g.p.keyName]]] : this) });
                        break;
                    case "adjacency":
                ...
                if (d.grid && d.p.treeGrid) switch (d.p.treeGridModel) {
                    case "nested":
                        var
                            ...
                            i = parseInt(b[f], 10),
                            j = parseInt(b[g], 10);
                        a(this.p.data).each(function() { parseInt(this[g], 10) === j + 1 && parseInt(this[e], 10) > h && parseInt(this[f], 10) < i && c.push(this) });
                        break;
                    case "adjacency":
                        var
                            k = d.p.treeReader.parent_id_field,
                            l = d.p.localReader.id;
                        a(this.p.data).each(function() { this[k] == a.jgrid.stripPref(d.p.idPrefix, b[l]) && c.push(this) })
                }
            }), c
        },
        ...
        reloadNode: function(b) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    b[e] = !0, a("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"), this.p.treeANode = l.rowIndex, this.p.datatype = this.p.treedatatype, "nested" === this.p.treeGridModel ? a(this).jqGrid("setGridParam", { postData: { nodeid: k, n_left: b[i], n_right: b[j], n_level: b[h] } }) : a(this).jqGrid("setGridParam", { postData: { nodeid: k, parentid: b[f], n_level: b[h] } }), a(this).trigger("reloadGrid"), b[g] = !0, "nested" === this.p.treeGridModel ? a(this).jqGrid("setGridParam", { selrow: d, postData: { nodeid: "", n_left: "", n_right: "", n_level: "" } }) : a(this).jqGrid("setGridParam", { selrow: d, postData: { nodeid: "", parentid: "", n_level: "" } })
                }
            })
        },
        ...
        searchTree: function(b) {
            ...
            return this.each(function() {
                if (this.grid && this.p.treeGrid && f)
                    for (d = this.p.localReader.id, c = 0; f > c; c++) g = a(this).jqGrid("getNodeAncestors", b[c]), g.length || g.push(b[c]), e = g[g.length - 1][d], -1 === a.inArray(e, h) && (h.push(e), g = a(this).jqGrid("getFullTreeNode", g[g.length - 1], !0), i = i.concat(g)) }), i
        },
                ...
                o(b, c, d, e) {
                    ...
                    for (a.isArray(d) ? (k = d.length, o = d) : (k = 1, o[0] = d), h = [], i = [], h.root = 0, e._count ? e._count++ : e._count = 1, j = 0; k > j; j++) {
                        ...
                        for (f = 0; l > f; f++) {
                            ...
                            else { p = d[j].replace(/\s+/g, "");
                                try { g = 1 === l ? m + p : m + p + "_" + c[f].aggregator + "_" + String(f) } catch (r) {}
                                o[j] = d[j] }
                    ...
                    for (d in
                        ...
                        if (a.hasOwnProperty(d)) {
                            if ("object" != typeof a[d]) {
                                if ("level" === d) {
                                    if (void 0 === L[a.level] && (L[a.level] = "", a.level > 0 && -1 === a.text.indexOf("_r_Totals") && (k[a.level - 1] = { useColSpanStyle: !1, groupHeaders: [] })), L[a.level] !== a.text && a.children.length && -1 === a.text.indexOf("_r_Totals") && a.level > 0) {
        ...
        saveState: function(b, c) {
            if (c = a.extend({ useStorage: !0, storageType: "localStorage", beforeSetItem: null, compression: !1, compressionModule: "LZString", compressionMethod: "compressToUTF16" }, c || {}), b) {
                var
                    ...
                    h = a("#" + b)[0];
                if (h.grid) {
                    if (e = a(h).data("inlineNav"), e && h.p.inlineNav && a(h).jqGrid("setGridParam", { _iN: e }), e = a(h).data("filterToolbar"), e && h.p.filterToolbar && a(h).jqGrid("setGridParam", { _fT: e }), f = a(h).jqGrid("jqGridExport", { exptype: "jsonstring", ident: "", root: "" }), a(h.grid.bDiv).find(".ui-jqgrid-btable tr:gt(0)").each(function(a, b) { g += b.outerHTML }), a.isFunction(c.beforeSetItem) && (d = c.beforeSetItem.call(h, f), null != d && (f = d)), c.compression && c.compressionModule) try { d = window[c.compressionModule][c.compressionMethod](f), null != d && (f = d, g = window[c.compressionModule][c.compressionMethod](g)) } catch (i) {}
                    if (c.useStorage && a.jgrid.isLocalStorage()) try { window[c.storageType].setItem("jqGrid" + h.p.id, f), window[c.storageType].setItem("jqGrid" + h.p.id + "_data", g) } catch (i) { 22 === i.code && alert("Local storage limit is over!") }
                    return f }
            }
        },
